...
function buildPlannerPrompt(input) {
  ...
  return [
    ...
    '- resizeCanvas absolute: { action, mode: "absolute", width, height, anchor?, sourceText }',
    '- resizeCanvas relative: { action, mode: "relative", direction, anchor?, amount?, sourceText }',
    '- batch: { action: "batch", sourceText, commands: [create | move | recolor | resize | delete | resizeCanvas] }',
    ...
    '- A batch command must contain 2 to 6 commands. Each command must be one existing standard command: create, move, recolor, resize, delete, or resizeCanvas.',
